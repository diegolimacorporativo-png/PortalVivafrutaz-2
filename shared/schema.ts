...
// ─── Immutable Audit Logs (Query Firewall) ────────────────────────────────────
// Append-only table that records every sensitive admin query passing through
// the query firewall. Never updated or deleted — purely additive audit trail.
