 ...
 *
 * Rule: modifications are allowed until 13:00 BRT (= 16:00 UTC) on the
 * second-to-last business day before the delivery date.
 *
 * Examples (business days only — Sat/Sun ignored):
 *   Monday    delivery → Thursday  13:00 BRT deadline
 *   Tuesday   delivery → Friday    13:00 BRT deadline (previous week)
 *   Wednesday delivery → Monday    13:00 BRT deadline
 *   Thursday  delivery → Tuesday   13:00 BRT deadline
 *   Friday    delivery → Wednesday 13:00 BRT deadline
 *
 * Brazil permanently uses UTC-3 (no DST since 2019), so 13:00 BRT = 16:00 UTC.
 */
 ...
 *  3. Deadline = step-2 day at 16:00 UTC (= 13:00 BRT).
 *
...
export function calculateOrderModificationDeadline(
  ...
  // 13:00 BRT = 16:00 UTC (Brazil has no DST since 2019)
