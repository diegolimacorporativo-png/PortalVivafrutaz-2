...
const SMTP_ROLES = ['MASTER', 'ADMIN', 'DIRECTOR', 'DEVELOPER'];

export function register(app: Express) {
  app.get('/api/smtp-config', requireAuthCore, requireRole(SMTP_ROLES), async (req: any, res) => {
    try {
  ...
  app.put('/api/smtp-config', requireAuthCore, requireRole(SMTP_ROLES), async (req: any, res) => {
    try {
  ...
  app.post('/api/smtp-config/test', requireAuthCore, requireRole(SMTP_ROLES), async (req: any, res) => {
    try {
